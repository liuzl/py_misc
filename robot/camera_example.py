...
def load_environment(client_id):
    ...
    # KUKA iiwa robot arm
    # kuka_id = pyb.loadURDF("kuka_iiwa/model.urdf", [0, 0, 0], useFixedBase=True, physicsClientId=client_id,)
    kuka_id = pyb.loadURDF("r2d2.urdf", [0, 0, 0], useFixedBase=True, physicsClientId=client_id,)

    bodies = {"robot": kuka_id, "ground": ground_id}
    return bodies
