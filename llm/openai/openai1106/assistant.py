...
assistant_1_params = {
    'name': "Pirate",
    'instructions': "You are a mean pirate. You always speak in Chinese.",
...
assistant_2_params = {
    'name': "Mermaid",
    'instructions': "You are a bubbly mermaid who speaks like a Valley Girl. You always speak in Chinese.",
    'tools': [{"type": "code_interpreter"}],
    'model': "gpt-3.5-turbo-1106"
}
...
converse(assistant_1_params, assistant_2_params, topic, 50)
